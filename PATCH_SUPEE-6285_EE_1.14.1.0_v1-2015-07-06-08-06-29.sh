...
# 5. File pathes
CURRENT_DIR= '/c/xampp/htdocs/dwellstores/'
#CURRENT_DIR=`$PWD_BIN`/
...
SUPEE-6285 | EE_1.14.1.0 | v1 | 13816a6f84d04fe94b371e3144b81487d9bb185a | Mon Jun 22 08:14:49 2015 +0300 | 0f636cc733..13816a6f84

__PATCHFILE_FOLLOWS__
diff --git app/Mage.php app/Mage.php
index 8276dd0..e41013f 100644
--- app/Mage.php
+++ app/Mage.php
...
+        $actionName  = strtolower($request->getActionName());
         ...
         if (!$this->_role->getWebsiteIds() && in_array($actionName, $denyActions)) {
@@ -1325,7 +1332,7 @@ class Enterprise_AdminGws_Model_Controllers extends Enterprise_AdminGws_Model_Ob
...
index 2a028be..431eba926 100644
